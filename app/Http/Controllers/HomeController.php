...
//==========================specialization=======================================
    public function newSpecialization()
    {
        ...
        $f = Faculty::orderBy('faculty_name', 'ASC')->get();
        $p = Programme::all();
        return view('admin.specialization.index')->withF($f)->withP($p)->withFos($fos);
    }
...
//------------------------- view specialization --------------
    public function viewSpecialization()
    {
        $fos = $this->get_fos();
        $f = Faculty::orderBy('faculty_name', 'ASC')->get();
        return view('admin.specialization.view')->withF($f)->withFos($fos);
    }
//==============================post view ============================================================
    public function postViewSpecialization(Request $request)
    {
       ...
       if($request->faculty_id){
        ...
        return view('admin.specialization.view')->withS($s)->withF($f)->withD($d)->withId($id)
            ->withFf($fac)->withFos($fos);
    }
...
// -------------------- assign specialization ----------------------
    public function assignSpecialization()
    {
        $f = Faculty::orderBy('faculty_name', 'ASC')->get();
        $fos = $this->get_fos();
        return view('admin.specialization.assign')->withF($f)->withFos($fos);
    }
    ...
    public function postAssignSpecialization(Request $request)
    {
        ...
        $st = DB::connection('mysql2')->table('users')
            ->where([['entry_year', $s], ['fos_id', $fos_id], ['department_id', $d]])->orderBy('matric_number', 'ASC')->get();

        return view('admin.specialization.assign')->withF($f)->withU($st)->withDid($d)->withFosid($fos_id)->withS($s)->withFos($fos)->withSp($sp);
    }
    ...
    public function viewAssignSpecialization()
    {
        $fos = $this->get_fos();
        $f = Faculty::orderBy('faculty_name', 'ASC')->get();
        return view('admin.specialization.viewassign')->withF($f)->withFos($fos);
    }
    ...
    public function postViewAssignSpecialization(Request $request)
    {
       ...
       ->get();
        ...
        return view('admin.specialization.viewassign')->withF($f)->withFos($fos)->withU($user)->withDid($d)->withFosid($fos_id)->withS($s)->withSp($sp);
